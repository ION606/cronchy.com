import type { Lanyard } from '#build/components'; import type { Lanyard } from
'#build/components';
<template>
  <div id="app">
...
<script>
  import Lanyard from "~/src/lanyard";
  export default {
    data() {
      return {
        userId: "576097150359044106",
        lanyard: {},
        lanyardSocket: null,
      };
    },
    ...
    async mounted() {
      this.lanyardSocket = await Lanyard(this.userId, true);
